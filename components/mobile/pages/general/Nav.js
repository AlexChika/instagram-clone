...
const Nav = ({ title, showModal, sharebtn = false }) => {
  ...
  return (
    <nav className="sticky top-0 z-10 flex items-center justify-center bg-white dark:bg-black border-b border-b-slate-300 dark:border-b-neutral-700 h-11">
      <div className="flex justify-between px-4 w-full py-1 mx-auto">
